      ...
      <!-- ===== Header End ===== -->
        ...
        <main>
            ...
            <div class="bb ze ki xn 2xl:ud-px-0">
              <div class="tc _o">
                <div class="animate_left jn/2">
                  <h1 class="fk vj zp or kk wm wb">SECURITE HUMAINE</h1>
                  <p class="fq">
                    Approche centrée sur les individus qui vise à protéger les personnes contre les menaces diverses, qu'elles soient physiques, économiques, sociales ou environnementales. Elle va au-delà de la sécurité nationale, qui est généralement axée sur la protection des États, pour mettre l'accent sur le bien-être et la dignité des individus et des communautés.
                  </p>
                  ...
                  <div class="tc tf yo zf mb">
                    ...
                    <span class="tc sf">
                      <a href="#" class="inline-block ek xj kk wm"> Appelez-nous +212 6 77 88 99 11 </a>
                      <span class="inline-block">Pour toutes questions ou préoccupations</span>
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div class="tc uf zo xf ap zf bp mq">
                ...
                <div class="animate_top kn to/3 tc cg oq">
                  ...
                  <div>
                    ...
                    <p>Numéro de permanence est accessible jour et nuit, 7 jours sur 7.</p>
                  </div>
                </div>
                ...
                <div class="animate_top kn to/3 tc cg oq">
                  ...
                  <div>
                    <h4 class="ek yj go kk wm xb">Menaces prioritaires</h4>
                    <p>
                      <ul style="list-style: circle;">
                        <li>Conflits armés ou violence intercommunautaire.</li>
                        <li>Inégalités économiques et pauvreté.</li>
                        <li>Catastrophes naturelles ou changement climatique.</li>
                      </ul>
                    </p>
                  </div>
                </div>
                ...
                <div class="animate_top kn to/3 tc cg oq">
                  ...
                  <div>
                    <h4 class="ek yj go kk wm xb">Adopter une approche multidimensionnelle</h4>
                    <p>
                      <ul style="list-style: circle;">
                        <li>Sécurité environnementale.</li>
                        <li>Sécurité personnelle.</li>
                        <li>Sécurité communautaire.</li>
                        <li>Sécurité politique.</li>
                      </ul>
                    </p>
                  </div>
                </div>
          ...
          <section class="i pg ji gp uq">
            ...
            <!-- Section Title Start -->
            <div
              x-data="{ sectionTitle: `Travail d'équipe`, sectionTitleText: `Le travail d’équipe possède une importance fondamentale pour tout type d’activité professionnelle. La mutualisation des moyens humains répond à des enjeux croissants ou encore à des besoins évolutifs.`}"
            >
            ...
            <div class="bb ze i va ki xn xq jb jo">
              <div class="wc qf pn xo gg cp">
                ...
                <div class="animate_top rj">
                  ...
                  <h4 class="yj go kk wm ob zb">Chris Brown</h4>
        ...
        <p class="bb on/5 wo/5 hq" x-text="sectionTitleText"></p>
          ...
          <section class="ji gp uq">
            <!-- Section Title Start -->
            <div
              x-data="{ sectionTitle: `FACILITY SERVICES`, sectionTitleText: `La division Facility services de MS7 Maroc couvre toutes les activités de support qui permettent aux clients de se concentrer sur leur métier de base et de contribuer à leur succès en optimisant leurs coûts et améliorant leur qualité. Notre atout majeur est basé sur l’expérience que nous avons acquise depuis 2010.`}"
            >
                <div class="animate_top bb ze rj ki xn vq">
                    <h2 x-text="sectionTitle" class="fk vj pr kk wm on/5 gq/2 bb _b"></h2>
                    <p class="bb on/5 wo/5 hq" x-text="sectionTitleText"></p>
              ...
              <div class="wc qf pn xo zf iq">
                ...
                <div class="animate_top sg vk rm xm">
                  <div class="c rc i z-1 pg">
                    ...
                    >
                      <a href="./blog-single.html" class="vc ek rg lk gh sl ml il gi hi">Lire La suite</a>
                    </div>
                  </div>
                  ...
                  <div class="yh">
                    ...
                    <h4 class="ek tj ml il kk wm xl eq lb">
                      <a href="blog-single.html">L'agent de nettoyage industriel</a>
                    </h4>
                  </div>
                </div>
                ...
                <div class="animate_top sg vk rm xm">
                  ...
                  <div class="yh">
                    ...
                    <h4 class="ek tj ml il kk wm xl eq lb">
                      <a href="blog-single.html">Maintenance technique du bâtiment</a>
                    </h4>
                  </div>
                </div>
                ...
                <div class="animate_top sg vk rm xm">
                  ...
                  <div class="yh">
                    ...
                    <h4 class="ek tj ml il kk wm xl eq lb">
                      <a href="blog-single.html">Entretien des espaces verts</a>
                    </h4>
                  </div>
                </div>
              </div>
                  ...
                  <div class="vd ro tc sf rn un gg vn">
                    <div class="animate_top">
                      ...
                      <ul>
                        ...
                        <li><a href="#" class="sc xl vb">Services</a></li>
                      </ul>
                    </div>
                    ...
                    <div class="animate_top">
                      ...
                      <ul>
                        <li><a href="#" class="sc xl vb">Société</a></li>
                        <li><a href="#" class="sc xl vb">Contactez-nous</a></li>
                      </ul>
                    </div>
